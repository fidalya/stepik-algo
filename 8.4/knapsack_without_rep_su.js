 ...
 * 
 * The first line of the input contains integers 1 ≤ W ≤ 10^4 and 1 ≤ n ≤ 300 — the backpack's capacity and the number of gold bars.
 * The next line contains the numbers 0 ≤ w_1,..., w_n ≤ 10^5, specifying the weight of the bars. A large weight of gold can be carried in a backpack.
 */
